...
class Visual {
    constructor(options) {
        this.svg = d3__WEBPACK_IMPORTED_MODULE_1__/* .select */ .Ys(options.element).append("svg");
    }
    update(options) {
        ...
        let blockSizePercentage = 100 / 12;
...
/* harmony export */ });
/* harmony import */ var _src_visual__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(18104);
/* provided dependency */ var window = __webpack_require__(26738);

var powerbiKey = "powerbi";
var powerbi = window[powerbiKey];
var busVisual_DEBUG = {
    name: 'busVisual_DEBUG',
    displayName: 'BusVisual',
    class: 'Visual',
    apiVersion: '3.8.0',
    create: (options) => {
...
if (typeof powerbi !== "undefined") {
    ...
    powerbi.visuals.plugins["busVisual_DEBUG"] = busVisual_DEBUG;
}
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (busVisual_DEBUG);

})();

busVisual_DEBUG = __webpack_exports__;
/******/ })()
;
